        ...
        daemon.cmd('getmininginfo', params,
            function (result) {
                ...
                if (result[0].response.difficulty !== null) {
                    finalRedisCommands.push(['hset', coin + ':network', 'difficulty', result[0].response.difficulty*8192]);
                }
                if (result[0].response.networkhashps !== null) {
                    finalRedisCommands.push(['hset', coin + ':network', 'hashrate', result[0].response.networkhashps]);
                }
